...
class Cache {
  List<Future<NodeInfo>> _categories;
  List<Future<NodeInfo>> _organizations;
  ...
  void initOrganizations(List<Future<NodeInfo>> nodes) {
    this._organizations = nodes;
  }

  void initCategories(List<Future<NodeInfo>> nodes) {
  ...
  List<Future<NodeInfo>> get organizations => _organizations;

  List<Future<NodeInfo>> get categories => _categories;
